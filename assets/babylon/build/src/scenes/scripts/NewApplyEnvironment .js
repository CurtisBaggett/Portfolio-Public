...
var ApplyEnvironment = /** @class */ (function (_super) {
    ...
    function ApplyEnvironment() {
        ...
        ///////////////////////////////////////////////////////////////////////
        //////////////////////Start Edit///////////////////////////////////////
        _this.playBtnAnimations = ['explode', 'openclose'];
        ...
        if (this.openAnimations.length) {
            if (!this.openAdded) {
                if (document.getElementById('openBtn')) {
                    ...
                    document.getElementById('openBtn').addEventListener('click', function () { return _this.OpenAnimation(); });
                    this.openAdded = true;
                }
            }
        }
    ...
    ApplyEnvironment.prototype.OpenAnimation = function () {
    };
...
//# sourceMappingURL=NewApplyEnvironment%20.js.map